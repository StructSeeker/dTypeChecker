...
I suppose formally-verifiy a type checker would not be small work. Proving NbE's termination likely requires logical relations and newman theorem for abstract rewriting. Beyond that, elaboration is another gap: right now bidirectional checking returns exception or unit, but modern proof assistant produce unification constraints for meta-variables. Speaking of which, i heard that de bruijn level fits the purpose of unfication constraints better, again an unknown for me.